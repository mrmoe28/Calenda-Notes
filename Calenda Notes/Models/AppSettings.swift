...
final class AppSettings: ObservableObject {
    ...
    @Published var userNickname: String {
        didSet { UserDefaults.standard.set(userNickname, forKey: "user_nickname") }
    }
    ...
    private init() {
        ...
        // User profile - persists across rebuilds
        self.userName = UserDefaults.standard.string(forKey: "user_name") ?? "Moe"
        self.userNickname = UserDefaults.standard.string(forKey: "user_nickname") ?? ""
    }
    ...
    func resetToDefaults() {
        ...
        // Note: Don't reset userName - that's personal data
    }
}
